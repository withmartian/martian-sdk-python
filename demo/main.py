...
def main():
    ...
    # fix that
    print(f"Running router via run method with quality_constraint")
    client.routers.run(updated_router.id, routing_constraint=quality_constraint, completion_request=openai_completion_request)
